...
public class GraphDemoFrame extends JFrame {
    ...
    private JButton buttonGraphMadeChain;
    private JButton buttonGraphvizMadeChain;
    ...
    public GraphDemoFrame() {
        ...
        buttonGraphMadeChain.addActionListener(e -> {
            long start = System.currentTimeMillis();
            int numberOfDeletedVertex = graph.createChain();
            System.out.println("Time: " + (System.currentTimeMillis() - start));
            try {
                panelGraphPainter.paint(dotToSvg(graph.toDot()));
                textAreaSystemOut.setText("Вершин удалено: " + numberOfDeletedVertex);
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        textAreaGraphFile.setText("10 10 0 1 0 2 1 2 1 3 1 4 2 3 3 4 2 5 5 4 5 3 ");
        ...
        buttonGraphMadeChain = new JButton();
        buttonGraphMadeChain.setText("Сделать цепочку");
        panel3.add(buttonGraphMadeChain, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        buttonGraphvizMadeChain = new JButton();
        buttonGraphvizMadeChain.setText("Сделать цепочку");
        panel11.add(buttonGraphvizMadeChain, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
